...
class DoxxingSettings:
    ...
    pii_config: Dict[str, DoxxingPIIConfig] = field(default_factory=lambda: {
        ...
        "bitcoin": DoxxingPIIConfig(enabled=True, weight=0.75),
        "ethereum": DoxxingPIIConfig(enabled=True, weight=0.75),
        "crypto_wallet": DoxxingPIIConfig(enabled=True, weight=0.70),
        "swift_bic": DoxxingPIIConfig(enabled=True, weight=0.60),
        "passport": DoxxingPIIConfig(enabled=True, weight=0.85),
        "driver_license": DoxxingPIIConfig(enabled=True, weight=0.70),
        "ssn": DoxxingPIIConfig(enabled=True, weight=0.90),
        "tax_id": DoxxingPIIConfig(enabled=True, weight=0.75),
        "national_id": DoxxingPIIConfig(enabled=True, weight=0.65),
        "student_id": DoxxingPIIConfig(enabled=True, weight=0.45),
        "university_email": DoxxingPIIConfig(enabled=True, weight=0.35),
        "fingerprint": DoxxingPIIConfig(enabled=True, weight=0.95),
        "dna": DoxxingPIIConfig(enabled=True, weight=0.95),
    })
